    ...
    <form class="padrao" id="form_cadastro" name="form_cadastro" method="post">
        <fieldset>
            ...
            <div class="item-form hases">
                ...
                <select id="fRegistro" name="fRegistro" style='width: 80px;' >
                    <option value="N" selected="">Normal</option>
                    <option value="O">Only 1</option>
        ...
        <fieldset>
            ...
            <div class="item-form campos">
                ...
                <label for="fSmall">Small</label>
                <select id="fSmall" name="fSmall[]" style='width: 60px;' >
                    <option value="S">Sim</option>
                    <option value="N" selected>Não</option>
                </select>
    ...
    function setTamanho(put) {
        ...
        if (list.children) {
            ...
            switch (put.value) {
                case "VARCHAR":
                    child.value = 100;
                    //SETA O CAMPO COM TAMANHO NORMAL
                    list.children[19].value = "N";
                    break;
                case "PASSWORD":
                    child.value = 32;
                    //SETA O CAMPO COM TAMANHO NORMAL
                ...
                case "INT":
                    ...
                    //SETA O CAMPO COM TAMANHO PEQUENO
                    list.children[19].value = "S";
                    break;
                case "DECIMAL":
                    child.value = "10,2";
                    //SETA O VALOR DEFAULT COMO 0
...
<div id="instrucoes">
    <ul>
        ...
        <li>Registro: Define como serão cadastrados os registros do módulo(Normal - auto explicativo; Only 1 - Aceita apenas 1 resgistro (Exemplo: 
            Empresa, Normas de Uso); Disabled - Registros não editáveis (Exemplo: Contato)).</li>
        ...
        <li>Small: Adiciona a classe "pequeno" no input (definido no CSS).</li>
    </ul>
</div>
